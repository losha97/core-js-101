...
describe('02-numbers-tasks', () => {
  ...
  it.optional('getCicleCircumference should return a circumference of cicle', () => {
    assert.strictEqual(tasks.getCicleCircumference(5), 31.41592653589793);
    assert.strictEqual(tasks.getCicleCircumference(3.14), 19.729201864543903);
    assert.strictEqual(tasks.getCicleCircumference(0), 0);
  });
  ...
  it.optional('getParallelipidedDiagonal should return a diagonal length of the rectagular parallepiped', () => {
    assert.strictEqual(tasks.getParallelipidedDiagonal(1, 1, 1), Math.sqrt(3));
    assert.strictEqual(tasks.getParallelipidedDiagonal(3, 3, 3), Math.sqrt(27));
    assert.strictEqual(tasks.getParallelipidedDiagonal(1, 2, 3), Math.sqrt(14));
  });
